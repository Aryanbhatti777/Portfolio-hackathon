...
const Work = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            description:
                "A responsive e-commerce experience with product discovery, categories, cart management, and a streamlined checkout flow.",
            ...
            <div className="relative mx-auto max-w-7xl">
                ...
                >
                    ...
                    >
                        ...
                        built with a focus on performance, usability,
                ...
                >
                    {projects.map((project, index) => (
                        <article
                            key={project.number}
                            className={`projectCard group border-b border-white/[0.08] py-16 lg:py-24 ${index === 0 ? "pt-0" : ""
                                }`}
                        >
                            ...
                            <div className="mb-10 grid gap-6 lg:grid-cols-[80px_1fr_auto] lg:items-end">
                                ...
                                <div
                                    className="projectNumber text-sm font-medium tracking-[0.2em] text-zinc-600"
                                >
                                    {project.number}
                                </div>
                            ...
                            >
                                ...
                                <img
                                    ...
                                    className="projectImage h-full w-full object-cover object-top transition-transform duration-700 ease-out group-hover:scale-[1.03]"
                                />
                                ...
                                <div className="absolute bottom-6 left-6 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100 sm:bottom-8 sm:left-8">
                            ...
                            <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_1fr_auto] lg:items-start">
                                ...
                                <div className="lg:hidden">
                                    <div className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 text-lg text-zinc-500">
                                        ↗
                                    </div>
                                </div>
                            </div>
